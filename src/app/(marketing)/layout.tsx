/* ============================================
   ...
   Wraps the public marketing site (/, /about,
   /services, /contact). This is one of TWO root
   layouts — the portal at /portal has its own
   root layout with NO marketing chrome.
   Loads fonts, sets metadata, renders the
   PlexusBackground + Navbar + Footer.
   ============================================ */
