...
function PeopleDeskCard() {
  ...
  return (
    <a
      href="https://peopledesk.vercel.app/"
      target="_blank"
      rel="noreferrer"
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
    ...
    >
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        <Image
          src="/images/projects/peopledesk.png"
          alt="PeopleDesk"
          fill
          sizes="(max-width: 900px) 100vw, 33vw"
          style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
            <div>
              ...
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '9px', color: 'rgba(255,255,255,0.45)', letterSpacing: '1.2px', textTransform: 'uppercase' as const }}>
                Role-based HR self-service portal
              </div>
            </div>
            <div style={{
              fontSize: '10px', fontFamily: 'var(--font-body)', color: '#8B5CF6',
          ...
          <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap' as const }}>
            {['HR Portal', 'Role-based Access', 'Self-service', 'Employee Data'].map(tag => (
              <span key={tag} style={{
                fontFamily: 'var(--font-body)', fontSize: '9px',
                color: 'rgba(255,255,255,0.5)', backgroundColor: 'rgba(0,0,0,0.4)',
                border: '1px solid rgba(255,255,255,0.1)', borderRadius: '4px',
...
/* ---- StoreOps — store back-office dashboard ---- */
function StoreOpsCard() {
  const [hovered, setHovered] = useState(false)

  return (
    <a
      href="https://storeops-rho.vercel.app"
      target="_blank"
      rel="noreferrer"
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
    ...
    >
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        <Image
          src="/images/projects/storeops.png"
          alt="StoreOps"
          fill
          sizes="(max-width: 900px) 100vw, 33vw"
          style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap' as const }}>
            {['Inventory', 'Orders', 'Analytics', 'Staff Management'].map(tag => (
              <span key={tag} style={{
                fontFamily: 'var(--font-body)', fontSize: '9px',
                color: 'rgba(255,255,255,0.5)', backgroundColor: 'rgba(0,0,0,0.4)',
                border: '1px solid rgba(255,255,255,0.1)', borderRadius: '4px',
  ...
  return (
    <MockupGrid
      ...
      items={[
        ...
        { card: <StoreOpsCard />, info: { label: 'Store Back-Office Dashboard', color: '#2C6E49', desc: 'Inventory, orders, analytics & staff management' } },
      ]}
    />
  )
}
